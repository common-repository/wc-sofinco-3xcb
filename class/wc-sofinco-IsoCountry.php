...
/*
/*******************************************************************************************************
 * DATASET (blatantly) TAKEN FROM 'class CountryArray' on phpclasses.org !
...
require_once(__DIR__ . '/lib/Mobile_Validator.php');
...
class IsoCountry
{
    ...
    private $_countries = array(
        ...
        "AX" => array( 'alpha2'=>'AX', 'alpha3'=>'ALA', 'num'=>'248', 'isd'=> '358', "name" => "�land Islands", "continent" => "Europe"),
        ...
        "CW" => array( 'alpha2'=>'CW', 'alpha3'=>'CUW', 'num'=>'531', 'isd'=> '599', "name" => "Cura�ao", "continent" => "North America"),
        ...
        "BL" => array( 'alpha2'=>'BL', 'alpha3'=>'BLM', 'num'=>'652', 'isd'=> '590', "name" => "Saint Barth�lemy", "continent" => "North America"),
